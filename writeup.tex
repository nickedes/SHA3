...
\draw (6,0) grid (11,5);
    ...
    \draw[thick,->] (9, -0.5) -- node [left] {$\chi, \iota, \theta$} (9, -2);
\end{tikzpicture}
\end{center}
% \[
% \]
...
\draw (10,0) grid (15,5);
    ...
    \node[] at (14.5,4.5) {h4'};
     ...
     \node[anchor=center] at (8.5, -0.5) {Fig 2: Diagram of the 2-round preimage attack. Each square represents a 64 bit lane.};
\end{tikzpicture}
\end{center}    
